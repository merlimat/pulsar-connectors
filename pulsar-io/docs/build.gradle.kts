...
dependencies {
    ...
    implementation(project(":pulsar-io:pulsar-io-debezium:mysql"))
    implementation(project(":pulsar-io:pulsar-io-debezium:postgres"))
    implementation(project(":pulsar-io:pulsar-io-debezium:mongodb"))
    implementation(project(":pulsar-io:pulsar-io-debezium:mssql"))
    implementation(project(":pulsar-io:pulsar-io-debezium:oracle"))
    ...
    implementation(project(":pulsar-io:pulsar-io-jdbc:clickhouse"))
    implementation(project(":pulsar-io:pulsar-io-jdbc:mariadb"))
    implementation(project(":pulsar-io:pulsar-io-jdbc:openmldb"))
    implementation(project(":pulsar-io:pulsar-io-jdbc:postgres"))
    implementation(project(":pulsar-io:pulsar-io-jdbc:sqlite"))

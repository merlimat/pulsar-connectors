...
dependencies {
    compileOnly("org.apache.pulsar:pulsar-io-core")
    implementation("org.apache.pulsar:pulsar-common")
    implementation("org.apache.pulsar:pulsar-functions-utils")
    ...
    testImplementation("org.apache.pulsar:pulsar-broker")
    // TODO: publish pulsar-broker test fixtures as a separate artifact
    // testImplementation(project(path = ":pulsar-broker", configuration = "testJar"))
    testImplementation("org.apache.pulsar:testmocks")

...
dependencies {
    implementation("org.apache.pulsar:pulsar-io-core")
    ...
    implementation("org.apache.pulsar:pulsar-io-data-generator")
    implementation(project(":debezium:mysql"))
    implementation(project(":debezium:postgres"))
    implementation(project(":debezium:mongodb"))
    implementation(project(":debezium:mssql"))
    implementation(project(":debezium:oracle"))
    ...
    implementation(project(":jdbc:clickhouse"))
    implementation(project(":jdbc:mariadb"))
    implementation(project(":jdbc:openmldb"))
    implementation(project(":jdbc:postgres"))
    implementation(project(":jdbc:sqlite"))
    ...
    implementation("org.apache.pulsar:pulsar-io-batch-data-generator")
}

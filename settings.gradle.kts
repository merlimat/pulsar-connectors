...
if (!settings.extra.has("coreModules")) {
    ...
    include("pulsar-io:pulsar-io-jdbc:core")
    project(":pulsar-io:pulsar-io-jdbc:core").projectDir = file("pulsar-io/jdbc/core")
    include("pulsar-io:pulsar-io-jdbc:clickhouse")
    project(":pulsar-io:pulsar-io-jdbc:clickhouse").projectDir = file("pulsar-io/jdbc/clickhouse")
    include("pulsar-io:pulsar-io-jdbc:mariadb")
    project(":pulsar-io:pulsar-io-jdbc:mariadb").projectDir = file("pulsar-io/jdbc/mariadb")
    include("pulsar-io:pulsar-io-jdbc:openmldb")
    project(":pulsar-io:pulsar-io-jdbc:openmldb").projectDir = file("pulsar-io/jdbc/openmldb")
    include("pulsar-io:pulsar-io-jdbc:postgres")
    project(":pulsar-io:pulsar-io-jdbc:postgres").projectDir = file("pulsar-io/jdbc/postgres")
    include("pulsar-io:pulsar-io-jdbc:sqlite")
    project(":pulsar-io:pulsar-io-jdbc:sqlite").projectDir = file("pulsar-io/jdbc/sqlite")

    // IO Debezium
    include("pulsar-io:pulsar-io-debezium")
    project(":pulsar-io:pulsar-io-debezium").projectDir = file("pulsar-io/debezium")
    include("pulsar-io:pulsar-io-debezium:core")
    project(":pulsar-io:pulsar-io-debezium:core").projectDir = file("pulsar-io/debezium/core")
    include("pulsar-io:pulsar-io-debezium:mongodb")
    project(":pulsar-io:pulsar-io-debezium:mongodb").projectDir = file("pulsar-io/debezium/mongodb")
    include("pulsar-io:pulsar-io-debezium:mssql")
    project(":pulsar-io:pulsar-io-debezium:mssql").projectDir = file("pulsar-io/debezium/mssql")
    include("pulsar-io:pulsar-io-debezium:mysql")
    project(":pulsar-io:pulsar-io-debezium:mysql").projectDir = file("pulsar-io/debezium/mysql")
    include("pulsar-io:pulsar-io-debezium:oracle")
    project(":pulsar-io:pulsar-io-debezium:oracle").projectDir = file("pulsar-io/debezium/oracle")
    include("pulsar-io:pulsar-io-debezium:postgres")
    project(":pulsar-io:pulsar-io-debezium:postgres").projectDir = file("pulsar-io/debezium/postgres")
